...
and needs to be modified to the international format, with "+1-" in
front of the phone number. Fill in the regular expression, using groups,
...
'''2. The multi_vowel_words function returns all words with 3 or more
...
'''5. The convert_phone_number function checks for a U.S. phone number format:
